...
namespace CrosswordApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            _userManager.AddUser("Misbah", "Misbah1808", "Hello123", "misbah@gmail.com", "player");
            _userManager.AddUser("Bob", "Bob123", "password", "bob@outlook.com", "admin");
            ...
            _userManager.VerifyUser(username, password);
